...
* Slack
    ...
    - Optional: some put a mortar-board icon next to our name, as a signal that people can ask us questions. 
* Meetup
    - [here](https://www.meetup.com/pei-developers/)
    - We use it but aren't sure how many people pay attention (vs Slack).
* web-site
